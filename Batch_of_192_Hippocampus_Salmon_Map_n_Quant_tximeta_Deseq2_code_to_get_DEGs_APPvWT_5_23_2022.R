...
write.csv(as.data.frame(gene_expression_padj_ordered_from_dge_dds_hippo_gene_se_10filtered), file = "Batch_of_192_Hippocampus_DESeq2_APPvWT_DGE_Analysis_padj_sorted_5_23_2022.csv")


## Get a summary of DEGs with FDR (p adj) of <0.05
summary(results(dge_dds_hippo_gene_se_10filtered, alpha = 0.05))
## Output is that of the 20752 genes, 2823 genes were upregulated in APP and 2999 were downregulated 
...
## Could export the normalized counts to an excel file for Jmp analysis if wanted but won't do that today (5-23-2022)
...
plotCounts(dge_dds_hippo_gene_se_10filtered, gene = "ENSMUSG00000118672", intgroup = "APP")
