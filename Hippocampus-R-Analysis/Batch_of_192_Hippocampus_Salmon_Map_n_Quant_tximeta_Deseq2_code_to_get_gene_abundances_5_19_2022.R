...
## Batch of 192 Hippocampus Samples Using Salmon Mapped and Quantified with Mouse cdna Index start 5-19-2022
...
##This reduced total genes from 35682 to 23900
...
length(unique(gene_symbols$ENSEMBL))  #23900 unique emsembl gene names
length(unique(gene_symbols$SYMBOL))  ##20796 unique gene symbols
...
write.csv(transposed_filtered_gene_abundances,
          file = "Gene_Abundances(TPM)_for_filtered_genes_with_gene_symbols_as_column_names_Batch_of_192_Hippocampus_Salmon_map_and_quant_5_19_2022.csv")
