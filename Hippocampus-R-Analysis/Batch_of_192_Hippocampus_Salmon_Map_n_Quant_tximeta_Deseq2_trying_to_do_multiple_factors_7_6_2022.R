...
write.csv(as.data.frame(APP_results_padj_ordered), file = "Batch_of_192_Trimmed_Hippo_DESeq2_APP_v_WT_DGE_Analysis_all_controlled_padj_sorted_7_11_2022.csv")
